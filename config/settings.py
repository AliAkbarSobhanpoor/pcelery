...
SECRET_KEY = "django-insecure-9qyir4h#y4+gldak#&^)x-pl7$qe39z0l#s3pln%cv=)nn4d1^"
...
# for more information on static and media assets visit https://testdriven.io/blog/django-static-files/
...
# easy thumbnail config for image cropping and so on
